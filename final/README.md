...
Your final project is a three week assignment to be completed in three stages (proposal, development and testing, presentation). Proposals presentations will be **4/17**, and Final project presentations will be **5/1**.
...
Please post your final project documentation to a web page (blog post is fine) and link next to your name on the [final presentation wiki](https://github.com/ml5js/ML-for-the-Web-S26/wiki/Final-Presentations).
